use crate::{constants, models::auth_models::ResponseBody, middleware::jwt_crypto::CryptoService};
...
impl<S, B> Transform<S, B> for Authentication
where
...
impl<S, B> Service<Req> for AuthenticationMiddleware<S>
where
    S: Service<Req, Response = ServiceResponse<B>, Error = Error>,
    S::Future: 'static,
    B: 'static,
